...
int mm_map_file_frag(const mm_idx_t *idx, int n_segs, const char **fn, const mm_mapopt_t *opt, int n_threads)
{
	...
	// NOTE: insert two more steps
	kt_pipeline(pl_threads, worker_pipeline, &pl, 5); /* make workload, pipeline */
...
int mm_split_merge(int n_segs, const char **fn, const mm_mapopt_t *opt, int n_split_idx)
{
	...
	// kt_pipeline(2, worker_pipeline, &pl, 3); // NOTE: insert two more steps
	kt_pipeline(2, worker_pipeline, &pl, 5);
