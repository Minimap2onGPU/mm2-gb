...
#ifdef LISA_HASH
#include "lisa_hash.h"
extern void mm_idx_get_batched_c(uint64_t* minimizers, uint64_t num_minimizers, int64_t* pos, uint64_t** p_ptrs, int* num_hits);
// extern lisa_hash *lh;
#endif
...
//-----------------------------------
	...
	int64_t* lisa_pos = (int64_t*) malloc((fmax(32, (int)mv->n))* sizeof(int64_t));
	...
	mm_idx_get_batched_c(minimizers, mv->n, lisa_pos, cr_batch, t_batch); 
//-----------------------------------
